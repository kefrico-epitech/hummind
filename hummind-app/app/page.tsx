...
export default function HomePage() {
  ...
  return (
    <main className="min-h-screen bg-[#f5f1ef] text-[#141426]">
      ...
      {/* Footer */}
      <footer className="bg-[#f5f1ef] px-5 py-10 sm:px-8 lg:px-10 border-t border-[#e8e4df]">
        <div className="mx-auto max-w-[1120px]">
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-6 sm:gap-4">
            {/* Left: Logo + Main Links */}
            <div className="flex items-center justify-center sm:justify-start gap-8 text-[11px] text-[#8a8388]">
              <img src="/home/logo-footer.svg" alt="HummindOS" className="h-4 w-auto flex-shrink-0" />
              <div className="hidden sm:flex items-center gap-6">
                <Link href={'/produit' as Route} className="transition hover:text-[#1d1a23] focus:outline-none focus:ring-2 focus:ring-[#6d72d8] rounded px-1 py-1">
                  Notre produit
                </Link>
                <Link href={'/contact' as Route} className="transition hover:text-[#1d1a23] focus:outline-none focus:ring-2 focus:ring-[#6d72d8] rounded px-1 py-1">
                  Nous contacter
                </Link>
                <Link href={'/faq' as Route} className="transition hover:text-[#1d1a23] focus:outline-none focus:ring-2 focus:ring-[#6d72d8] rounded px-1 py-1">
                  FAQ
                </Link>
              </div>
            </div>
            ...
            {/* Center: Copyright */}
            <p className="text-center text-[11px] text-[#8a8388] sm:flex-1">© HummindOS 2025. Tous droits reserves.</p>

            {/* Right: Legal + Social */}
            <div className="flex items-center justify-center sm:justify-end gap-6 text-[11px] text-[#8a8388]">
              <Link href={'/conditions' as Route} className="transition hover:text-[#1d1a23] focus:outline-none focus:ring-2 focus:ring-[#6d72d8] rounded px-1 py-1">
                Conditions
              </Link>
              <Link href={'/confidentialite' as Route} className="transition hover:text-[#1d1a23] focus:outline-none focus:ring-2 focus:ring-[#6d72d8] rounded px-1 py-1">
                Confidentialite
              </Link>
              <div className="flex items-center gap-4 pl-2 border-l border-[#d8d3cd]">
                <a href="#" className="text-[#8a8388] hover:text-[#1d1a23] transition focus:outline-none focus:ring-2 focus:ring-[#6d72d8] rounded p-1" aria-label="LinkedIn">
                  <svg className="h-4 w-4" fill="currentColor" viewBox="0 0 24 24">
                    <path d="M20.447 20.452h-3.554v-5.569c0-1.328-.027-3.037-1.852-3.037-1.853 0-2.136 1.445-2.136 2.939v5.667H9.351V9h3.414v1.561h.046c.477-.9 1.637-1.85 3.37-1.85 3.601 0 4.267 2.37 4.267 5.455v6.286zM5.337 7.433c-1.144 0-2.063-.926-2.063-2.065 0-1.138.92-2.063 2.063-2.063 1.14 0 2.064.925 2.064 2.063 0 1.139-.925 2.065-2.064 2.065zm1.782 13.019H3.555V9h3.564v11.452zM22.225 0H1.771C.792 0 0 .774 0 1.729v20.542C0 23.227.792 24 1.771 24h20.451C23.2 24 24 23.227 24 22.271V1.729C24 .774 23.2 0 22.225 0z" />
                  </svg>
                </a>
                <a href="#" className="text-[#8a8388] hover:text-[#1d1a23] transition focus:outline-none focus:ring-2 focus:ring-[#6d72d8] rounded p-1" aria-label="X (Twitter)">
                  <svg className="h-4 w-4" fill="currentColor" viewBox="0 0 24 24">
                ...
                <a href="#" className="text-[#8a8388] hover:text-[#1d1a23] transition focus:outline-none focus:ring-2 focus:ring-[#6d72d8] rounded p-1" aria-label="Instagram">
                  <svg className="h-4 w-4" fill="currentColor" viewBox="0 0 24 24">
          ...
          <div className="sm:hidden flex items-center justify-center gap-6 mt-6 text-[11px] text-[#8a8388] border-t border-[#e8e4df] pt-6">
            <Link href={'/produit' as Route} className="transition hover:text-[#1d1a23] focus:outline-none focus:ring-2 focus:ring-[#6d72d8] rounded px-1 py-1">
              Notre produit
            </Link>
            <Link href={'/contact' as Route} className="transition hover:text-[#1d1a23] focus:outline-none focus:ring-2 focus:ring-[#6d72d8] rounded px-1 py-1">
