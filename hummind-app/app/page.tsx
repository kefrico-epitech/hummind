    ...
    <main className="min-h-screen bg-[#f5f1ef] text-[#141426]">
      ...
      <section className="relative overflow-hidden bg-[linear-gradient(180deg,#d8d9fb_0%,#f7ece7_54%,#f5f1ef_100%)] px-4 pb-16 pt-6 sm:px-6 sm:pb-24 sm:pt-8 lg:px-10 lg:pb-32 lg:pt-12">
        ...
        <div className="relative mx-auto max-w-[1120px]">
          <header className="mx-auto flex w-fit flex-row items-center gap-2 rounded-xl sm:rounded-full border border-white/85 bg-white/90 px-4 py-2.5 sm:px-3 sm:py-2 shadow-[0_16px_40px_rgba(28,22,54,0.12)] backdrop-blur sm:gap-2">
            <Link
              href={'/' as Route}
            ...
            >
              <Image src="/home/logo.png" alt="HummindOS" width={92} height={22} className="h-5 w-auto sm:h-5" />
            </Link>
            ...
            <Link
              href={'/demo' as Route}
              className="inline-flex items-center justify-center rounded-full bg-[#171729] px-4 py-2 text-[11px] sm:text-[12px] sm:px-5 sm:py-3 font-semibold text-white transition hover:bg-[#0f1020] hover:shadow-lg active:scale-95 focus:outline-none focus:ring-2 focus:ring-[#6d72d8] focus:ring-offset-2 min-h-[44px]"
