...
import {
  ...
  generateCourseActions,
} from "../../../../src/lib/ai/courseGeneration";
import { requireAuth } from "../../../../src/lib/server/requireAuth";

export const maxDuration = 300; // Allows up to 5 minutes for AI generation
...
export async function POST(req: Request) {
  ...
  try {
    ...
    const result = await generateCourseActions(body, {
